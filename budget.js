// in this app we will be using the local storage to store the budget and expenses
// we will be using the sweet alert library to display the alerts
// we will be using the bootstrap library for the UI
...
function addBudget() {
    ...
    remainingBudget.innerHTML = Math.max(0, remainingBalance).toFixed(2);
  }
